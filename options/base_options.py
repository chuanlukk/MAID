...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='res50', help='architecture for multi-classification')
        ...
        parser.add_argument('--dataroot', default='./dataset_DMA', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')

        parser.add_argument('--num_classes', default=5, type=int,  help='multi-classes-generators')
